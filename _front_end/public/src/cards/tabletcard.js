...
TabletCard, that are using the Card and Badge components from the React Bootstrap library,
 as well as the useNavigate hook from the react-router-dom library.
